...
```
docker build -t cogent3/my-first-docker-image:latest .
```
...
humphreydev5/my-first-docker-image   latest    960d37536dcd   26 seconds ago   467MB
...
```
docker run -it cogent3/my-first-docker-image
```
...
```
docker push humphreydev5/my-first-docker-image
```
...
The push refers to repository [docker.io/humphreydev5/my-first-docker-image]
896818320e80: Pushed
b8088c305a52: Pushed
69dd4ccec1a0: Pushed
